...
4. **M4 产品功能已实现**：Web 操作界面、责任链查询与浏览器自动验收；单人双客户端样例已完成人工验收，范围与限制见 [验收记录](docs/acceptance-2026-09-16.md)。

详细状态见 [MVP 验收矩阵](docs/mvp.md)。首个 Git 成果核验集成使用 GitHub，核心模型仍保持厂商无关；已验证客户端版本、协作证据和未覆盖项见 [M4 联合验收记录](docs/acceptance-2026-09-16.md)。
